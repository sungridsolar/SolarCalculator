...
feedback +="Your average daily electricity Consumption: "+Math.round(dailyUseKw)+" kwh per day.</p>";
...
feedback +="<p>The "+panelName+" panel you selected generates about "+panelOutput+" wats per hour.</p>";
